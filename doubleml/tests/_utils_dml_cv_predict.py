...
def _dml_cv_predict_ut_version(
    estimator, x, y, smpls=None, n_jobs=None, est_params=None, method="predict"
):
    ...
    if est_params is None:
        prediction_blocks = parallel(
            delayed(_fit_and_predict)(
                estimator, x, y, train_index, test_index, verbose, fit_params, method
            )
