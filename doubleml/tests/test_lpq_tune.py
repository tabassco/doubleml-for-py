...
def test_dml_lpq_se(dml_lpq_fixture):
    assert math.isclose(
        dml_lpq_fixture["se"], dml_lpq_fixture["se_manual"], rel_tol=1e-9, abs_tol=1e-4
    )
