...
def dml_plr_fixture(generate_data1, score, dml_procedure):
    ...
    dml_plr_obj_ext_set_par = dml.DoubleMLPLR(
        obj_dml_data,
        ml_l,
        ml_m,
        ml_g,
    ...
    for bootstrap in boot_methods:
        ...
        res_dict[
            "boot_coef" + bootstrap + "_manual"
        ] = dml_plr_obj_ext_set_par.boot_coef
        res_dict[
            "boot_t_stat" + bootstrap + "_manual"
        ] = dml_plr_obj_ext_set_par.boot_t_stat
