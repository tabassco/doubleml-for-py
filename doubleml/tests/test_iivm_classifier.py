...
def dml_iivm_classifier_fixture(
    generate_data_iivm_binary,
    learner,
    score,
    dml_procedure,
    normalize_ipw,
...
def test_dml_iivm_coef(dml_iivm_classifier_fixture):
    assert math.isclose(
        dml_iivm_classifier_fixture["coef"],
...
def test_dml_iivm_se(dml_iivm_classifier_fixture):
    assert math.isclose(
        dml_iivm_classifier_fixture["se"],
...
def test_dml_iivm_boot(dml_iivm_classifier_fixture):
    for bootstrap in dml_iivm_classifier_fixture["boot_methods"]:
        assert np.allclose(
            dml_iivm_classifier_fixture["boot_coef" + bootstrap],
