...
@pytest.fixture(
    scope="module", params=[RandomForestRegressor(max_depth=5, random_state=42)]
)
...
@pytest.fixture(
    scope="module", params=[RandomForestClassifier(max_depth=5, random_state=42)]
)
...
def dml_cvar_fixture(
    generate_data_quantiles,
    treatment,
    quantile,
    learner_g,
    learner_m,
