...
def dml_irm_classifier_fixture(
    generate_data_irm_binary,
    learner,
    score,
    dml_procedure,
    normalize_ipw,
...
def test_dml_irm_coef(dml_irm_classifier_fixture):
    assert math.isclose(
        dml_irm_classifier_fixture["coef"],
...
def test_dml_irm_boot(dml_irm_classifier_fixture):
    for bootstrap in dml_irm_classifier_fixture["boot_methods"]:
        assert np.allclose(
            dml_irm_classifier_fixture["boot_coef" + bootstrap],
